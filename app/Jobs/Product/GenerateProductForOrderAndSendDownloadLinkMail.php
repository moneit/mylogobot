...
use App\Jobs\Mail\SendDownloadLinkMail;


class GenerateProductForOrderAndSendDownloadLinkMail implements ShouldQueue
{
    ...
    public function handle()
    {
        if (empty($this->order->file_id)) {
            ...
            if (! is_null($fileId)) {
                ...
                SendDownloadLinkMail::dispatch($this->order);
            }
        }
