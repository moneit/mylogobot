...
class CreateLogoInitialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('logo_initials', function (Blueprint $table) {
            $table->increments('id');
...
//            $table->string('capitalization');
    ...
    {
        Schema::table('logo_initials', function(Blueprint $table) {
            $table->dropForeign('logo_initials_logo_id_foreign');
        });
        Schema::dropIfExists('logo_initials');
    }
}
